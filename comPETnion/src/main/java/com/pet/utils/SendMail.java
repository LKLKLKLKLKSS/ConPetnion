...
public class SendMail {
	...
	public void sendSimpleEmail(String to, String subject, String text) {
		...
		message.setFrom("q1qip789@gmail.com");
		message.setTo(to);
	...
	// 文章檢舉成功通知
	@Async
	public void sendReportSuccess(String to, String memberName, String postName, String reportContent, Date reportDate) throws MessagingException {
	    MimeMessage mimeMessage = mailSender.createMimeMessage();
	    MimeMessageHelper helper = new MimeMessageHelper(mimeMessage, true, "UTF-8");

	    helper.setFrom("your-email@gmail.com");
	    helper.setTo(to);
	    helper.setSubject("檢舉成功");

	    Context context = new Context();
	    context.setVariable("memberName", memberName);  // 確保這裡的變數名稱和模板中的變數名稱一致
	    ...
	    String htmlContent = templateEngine.process("/forum/mail/sendReportSuccess", context);
